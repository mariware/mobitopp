...
public enum ActitoppPersonParameters {
	...
	/*
	 * Properties fr Anzahl an Aktivitten in der Woche
	 */
	...
	/*
	 * Anzahl Tage mit spezifischen Aktivittentypen
	 */
	...
	/**
	 * 
	 * Methode zur Rckgabe des EnumValues fr einen gegebenen String
	 * 
	 * @param name
	 * @return
	 */
	...
	{
		// Eindeutigkeitsprfung
		checkUniqueness(name);
		
		// Rckgabe des passenden Enums
	...
	/**
	 * 
	 * Methode zur Prfung der Eindeutigkeit der Enum-Namensvariable
	 * 
	 * @param name
	 */
